  ...
  <div class="row">
    <div class="col-12">
      <div class="card profile-header mb-2">
        ...
        <img
          class="card-img-top"
          src="{{asset('images/profile/user-uploads/keluarga2.jpg')}}"
        ...
        <div class="position-relative" style="padding-top: 50px;">
          ...
          <div class="profile-img-container d-flex align-items-center">
            ...
            <div class="profile-title ms-3">
              <h2 class="text-primary" style="margin-top: 50px;">{{ Auth::user()->name }}</h2>
              <p class="text-primary">{{ Auth::user()->usersdetail->nric }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="profile-header-nav">
          <!-- navbar -->
          <nav class="navbar navbar-expand-md navbar-light justify-content-end justify-content-md-between w-100" style="margin-bottom: 25px;">
            <button
