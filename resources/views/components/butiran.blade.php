        ...
        <form>
          ...
          <div class="row">
            ...
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="short_name" name="short_name" class="form-control short_name" value="{{$form1['short_name']}}" placeholder="John"  readonly/>
            </div>
            <div class="mb-1 col-md-6">
            ...
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="place_of_birth" name="place_of_birth" class="form-control place_of_birth" value="{{Carbon\Carbon::parse($form1['date_of_birth'])->format('Y-m-d')}}" placeholder="Tg Malim" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="place_of_birth">{!! __('locale.POB') !!}</label>
              <input type="text" id="place_of_birth" name="place_of_birth" class="form-control place_of_birth" value="{{$form1['place_of_birth']}}" placeholder="Tg Malim" readonly/>
            </div>
            <div class="mb-1 col-md-12">
              <label class="form-label" for="address_1">{!! __('locale.Address') !!}</label>
              <textarea class="form-control address_1" id="address_1" name="address_1" rows="4" placeholder="" readonly>{{$form1['address_1']}}</textarea>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="race">{!! __('locale.Race') !!}</label>
              <input type="text" id="place_of_birth" name="place_of_birth" class="form-control place_of_birth" value="{{$form1['race']}}" placeholder="Tg Malim" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="state">{!! __('locale.State') !!}</label>         
              <input type="text" id="place_of_birth" name="place_of_birth" class="form-control place_of_birth" value="{{$form1['state']}}" placeholder="Tg Malim" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="gender">{!! __('locale.Gender') !!}</label>
              <input type="text" id="place_of_birth" name="place_of_birth" class="form-control place_of_birth" value="{{$form1['gender']}}" placeholder="Tg Malim" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="birth_cert_no">{!! __('locale.Birth Certificate') !!}</label>
              <input type="text" id="birth_cert_no" name="birth_cert_no" class="form-control birth_cert_no" value="{{$form1['birth_cert_no']}}" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="nationality">{!! __('locale.Nationality') !!}</label>
              <input type="text" id="nationality" name="nationality" class="form-control nationality" value="{{$form1['nationality']}}" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="phone_no">{!! __('locale.Phone_No') !!}</label>
              <input type="number" id="phone_no" name="phone_no" class="form-control phone_no" placeholder=" " value="{{$form1['phone_no']}}" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="house_no">{!! __('locale.House_No') !!}</label>
              <input type="number" id="house_no" name="house_no" class="form-control house_no" placeholder=" " value="{{$form1['tel_house']}}" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="dun">{!! __('locale.DUN') !!}</label>
              <input type="text" id="dun" name="dun" class="form-control dun" placeholder=" " value="{{$form1['dun']}}" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="parliament">{!! __('locale.Parliament') !!}</label>
              <input type="text" id="parliament" name="parliament" class="form-control parliament" placeholder=" " value="{{$form1['parliament']}}" readonly/>
            </div>
        ...
        <form>
          ...
          <div id="married_section">
            <div class="row">
              <div class="mb-1 col-md-4">
                ...
                <input type="text" id="vertical-partner_name" name="partner_name" value="{{$form2['partner_name']}}" class="form-control partner_name" placeholder="" readonly/>
              </div>
              <div class="mb-1 col-md-4">
                <label class="form-label" for="vertical-partner_no_tel">{!! __('locale.Partner_Phone_No') !!}</label>
                <input type="text" id="vertical-partner_no_tel" name="partner_no_tel" value="{{$form2['partner_no_tel']}}" class="form-control partner_no_tel" placeholder="" readonly/>
              </div>
              <div class="mb-1 col-md-4">
                <label class="form-label" for="vertical-no_phonehouse">{!! __('locale.Partner_House_No') !!}</label>
                <input type="text" id="vertical-no_phonehouse" name="partner_no_phonehouse" value="{{$form2['partner_no_phonehouse']}}" class="form-control partner_no_phonehouse" placeholder="" readonly/>
              </div>

              <div class="mb-1 col-md-12">
                <label class="form-label" for="vertical-partner_address_1">{!! __('locale.Partner_Address') !!}</label>
                <textarea class="form-control partner_address_1" id="label-partner_address_1" name="partner_address_1" rows="4" placeholder="" readonly>{{$form2['partner_address_1']}}</textarea>
              </div>  
            </div>
          </div>
          ...
          <div class="row">
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="vertical-guardian_name" name="guardian_name" value="{{$form2['guardian_name']}}" class="form-control guardian_name" placeholder="Doe" readonly />
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-relationship_guardian">{!! __('locale.Relationship_Guardian') !!}</label>
              <input type="text" id="vertical-relationship_guardian" name="relationship_guardian" value="{{$form2['relationship_guardian']}}" class="form-control relationship_guardian" placeholder="Doe" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-guardian_nric_old">{!! __('locale.Guardian_Nric_Old') !!}</label>
              <input type="text" id="vertical-guardian_nric_old" name="guardian_nric_old" value="{{$form2['guardian_nric_old']}}" class="form-control guardian_nric_old" placeholder="Doe" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-guardian_nric_new">{!! __('locale.Guardian_Nric_New') !!}</label>
              <input type="text" id="vertical-guardian_nric_new" name="guardian_nric_new" value="{{$form2['guardian_nric_new']}}" class="form-control guardian_nric_new" placeholder="Doe" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-guardian_no_tel">{!! __('locale.Guardian_Phone_No') !!}</label>
              <input type="text" id="vertical-guardian_no_tel" name="guardian_no_tel" value="{{$form2['guardian_no_tel']}}" class="form-control guardian_no_tel" placeholder="Doe" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-guardian_no_phonehouse">{!! __('locale.Guardian_House_No') !!}</label>
              <input type="text" id="vertical-guardian_no_phonehouse" name="guardian_no_phonehouse" value="{{$form2['guardian_no_phonehouse']}}" class="form-control guardian_no_phonehouse" placeholder="Doe" readonly/>
            </div>
          </div>
          ...
          <div class="row">
            <div class="mb-1 col-md-12">
              ...
              <textarea class="form-control guardian_address_1" id="label-guardian_address_1" name="guardian_address_1" rows="4" placeholder="" readonly>{{$form2['guardian_address_1']}}</textarea>
            </div>
          </div>
          ...
          <div class="row">
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="vertical-first-name" name="guardian_income" value="{{$form2['guardian_income']}}" class="form-control guardian_income" placeholder="John" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Guardian_Occupation') !!}</label>
              <input type="text" id="vertical-last-name" name="guardian_occupation" value="{{$form2['guardian_occupation']}}" class="form-control guardian_occupation" placeholder="Doe" readonly/>
            </div>
          </div>
          ...
          <div class="row">
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="vertical-first-name" name="guardian_dependent" value="{{$form2['number_of_dependents']}}" class="form-control guardian_dependent" placeholder="John" readonly/>
            </div>
            <div class="mb-1 col-md-6">
          ...
          <div class="row">
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="vertical-first-name" name="kin_name" value="{{$form2['kin_name']}}" class="form-control kin_name" placeholder="John" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Kin_Relationship') !!}</label>
              <input type="text" id="vertical-last-name" name="kin_relationship" value="{{$form2['kin_relationship']}}" class="form-control kin_relationship" placeholder="Doe" readonly/>
            </div>
          </div>
          <div class="row">
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-first-name">{!! __('locale.Kin_Phone_No') !!}</label>
              <input type="text" id="vertical-first-name" name="kin_no_tel" value="{{$form2['kin_no_tel']}}" class="form-control kin_no_tel" placeholder="John" readonly />
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Kin_House_No') !!}</label>
              <input type="text" id="vertical-last-name" name="kin_no_phonehouse" value="{{$form2['kin_no_phonehouse']}}" class="form-control kin_no_phonehouse" placeholder="Doe" readonly/>
            </div>
          </div>
          <div class="row">
            <div class="mb-1 col-md-6">
            ...
            <div class="mb-1 col-md-6">
              ...
              <textarea class="form-control kin_address_1" id="label-textarea" name="kin_address_1" rows="4" placeholder=""readonly>{{$form2['kin_address_1']}}</textarea>
            </div>
          </div>
        ...
        <form>
          <div class="row">
            ...
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="vertical-last-name" name="kin_no_phonehouse" value="{{$form3['study_mode']}}" class="form-control kin_no_phonehouse" placeholder="Doe" readonly/>
            </div>
          ...
          <div class="row">
            <div class="mb-1 col-md-12">
              ...
              <select class="form-select w-100 program_one" id="program_one" name="program_one" disabled>
            ...
            <div class="mb-1 col-md-12">
              ...
              <select class="form-select w-100 program_two" id="program_two" name="program_two" disabled>
                <option label="" selected disabled>{!! __('locale.Please Choose') !!}</option>
                @foreach ($programs as $program)
        ...
        <form>
          <div class="row">
            <div class="mb-1 col-md-2">
              ...
              <input type="text" id="vertical-last-name" value="{{$form4['year_muet']}}" name="year_muet" class="form-control year_muet" placeholder="" readonly />
            </div>
            <div class="mb-1 col-md-2">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Place_Muet') !!}</label>
              <input type="text" id="vertical-last-name" name="place_muet" value="{{$form4['result_grade']}}" class="form-control place_muet" placeholder="" readonly/>
            </div>
            <div class="mb-1 col-md-2">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Speaking_Grade') !!}</label>
              <input type="text" id="vertical-last-name" value="{{$form4['speaking_grade']}}" name="speaking_grade" class="form-control speaking_grade" placeholder="" readonly/>
            </div>
            <div class="mb-1 col-md-2">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Reading_Grade') !!}</label>
              <input type="text" id="vertical-last-name" name="reading_grade" value="{{$form4['reading_grade']}}" class="form-control reading_grade" placeholder="" readonly/>
            </div>
            <div class="mb-1 col-md-2">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Writing_Grade') !!}</label>
              <input type="text" id="vertical-last-name" name="writing_grade" value="{{$form4['writing_grade']}}" class="form-control writing_grade" placeholder="" readonly/>
            </div>
            <div class="mb-1 col-md-2">
              <label class="form-label" for="vertical-band">{!! __('locale.Band') !!}</label>
              <select class="select2 w-100 band" id="band" name="band" disabled>
                <option label=" "></option>
              ...
              <div class="row d-flex align-items-end">
                <div class="col-md-4 col-12">
                  <div class="mb-1">
                    ...
                    <input type="text" class="form-control institusidisplay" name="institusidisplay" id="institusidisplay" value="{{$kelulusan['institution_others_qc']}}"readonly>
                  </div>
                </div>
                <div class="col-md-2 col-12">
                      <div class="mb-1">
                        ...
                        <input type="text" name="gradedisplay" class="form-control gradedisplay" id="gradedisplay" value="{{$kelulusan['grade_others_qc']}}"readonly>
                      </div>
                    </div>
                    <div class="col-md-2 col-12">
                      <div class="mb-1">
                        ...
                        <input type="text" name="khususdisplay" class="form-control khususdisplay" id="khususdisplay" value="{{$kelulusan['specialization_others_qc']}}"readonly>
                      </div>
                    </div>
                    <div class="col-md-2 col-12">
                      <div class="mb-1">
                        ...
                        <input type="text" name="tahundisplay" class="form-control tahundisplay" id="tahundisplay" value="{{$kelulusan['year_others_qc']}}"readonly>
                      </div>
                    </div>
...
<p hidden id="form4value">0</p>
       ...
       <div class="row">
            ...
            <div class="custom-control custom-checkbox">
              <input type="checkbox" class="custom-control-input cert_related_program" value="Ada Sijil" id="cert_related_program" @if($form44['cert_related_program'] == "Ada Sijil") checked @else unchecked @endif disabled/>
            ...
            <div class="mb-1 col-md-6">
              ...
              <textarea class="form-control description_cert" id="description_cert" name="description_cert" rows="4" placeholder=""readonly>{{$form44['description_cert']}}</textarea>
            </div> 
          </div>
          ...
          <div class="row">
            ...
            <div class="demo-inline-spacing">
            <div class="custom-control custom-checkbox">
              <input type="checkbox" class="custom-control-input work_exp_related_program" value="Ada Sijil" id="work_exp_related_program" @if($form44['work_exp_related_program'] == "Ada Sijil") checked @else unchecked @endif disabled/>
            ...
            <div class="mb-1 col-md-6">
              ...
              <textarea class="form-control description_work_exp" id="description_work_exp" name="description_cert" rows="4" placeholder=""readonly>{{$form44['description_work_exp']}}</textarea>
            </div> 
          </div>
        ...
        <form>
          <div class="row">
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="vertical-last-name" name="year_pmr" class="form-control year_pmr" value="{{$pmryear}}" readonly/>
            </div>
          </div>
           ...
           <div data-repeater-list="" >
             ...
             @foreach($pmr as $PMR)
             <input hidden type="text" class="id_pmr"  name="id_pmr" id="id_pmr" value="{{$PMR['subject_gradeid']}}" readonly>
            ...
            <div data-repeater-item>
              <div class="row d-flex align-items-end">
                <div class="col-md-4 col-12">
                  ...
                  <select class="form-control" id="usubject_pmr" name="usubject_pmr" disabled>
                ...
                <div class="col-md-2 col-12">
                      <div class="mb-1">
                  <label class="form-label" for="itemname">Subjek</label>
                  <select class="form-control" id="ugrade_pmr" name="usgrade_pmr" disabled>
                    <option selected disabled>Please Choose</option>
                    <option selected disabled>Please Choose</option>
...
<p hidden id="pmrvalue">0</p>
          ...
          <div class="row">
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="vertical-last-name" name="year_spm" class="form-control year_spm" value="{{$spmyear}}" readonly/>
            </div>
          </div>
            ...
            <div data-repeater-item>
              <div class="row d-flex align-items-end">
                <div class="col-md-4 col-12">
                  <div class="mb-1">
                  <label class="form-label" for="itemname">Subjek</label>
                  <select class="form-control" id="usubject_spm" name="usubject_spm" disabled>
                    <option selected disabled>Please Choose</option>
                ...
                <div class="col-md-2 col-12">
                      <div class="mb-1">
                  <label class="form-label" for="itemname">Subjek</label>
                  <select class="form-control" id="ugrade_spm" name="usgrade_spm" disabled>
                    <option selected disabled>Please Choose</option>
...
<p hidden id="spmvalue">0</p>
          ...
          <div class="row">
            <div class="mb-1 col-md-4">
              ...
              <input type="text" id="vertical-last-name" name="year_stpm" class="form-control year_stpm" value="{{$stpmyear}}" readonly/>
            </div>
          </div>
            ...
            <div data-repeater-item>
              <div class="row d-flex align-items-end">
                <div class="col-md-4 col-12">
                  <div class="mb-1">
                  <label class="form-label" for="itemname">Subjek</label>
                  <select class="form-control" id="usubject_stpm" name="usubject_stpm" disabled>
                    <option selected disabled>Please Choose</option>
                ...
                <div class="col-md-2 col-12">
                      <div class="mb-1">
                  <label class="form-label" for="itemname">Subjek</label>
                  <select class="form-control" id="ugrade_stpm" name="usgrade_stpm" disabled>
                    <option selected disabled>Please Choose</option>
            ...
            <div data-repeater-item>
              <div class="row d-flex align-items-end">
                <div class="col-md-4 col-12">
                  ...
                  <input type="text" class="form-control uarea_involvement" name="uarea_involvement" id="uarea_involvement" value="{{$Form6['area_involvement']}}" readonly>
                  </div>
                </div>
                <div class="col-md-4 col-12">
                      <div class="mb-1">
                      <label class="form-label" for="vertical-last-name">{!! __('locale.Organizer') !!}</label>
                      <input type="text" id="uorganizer" name="uorganizer" class="form-control uorganizer" value="{{$Form6['organizer']}}" readonly/>
                      </div>
                  </div>
                  <div class="col-md-2 col-12">
                      <div class="mb-1">
                      <label class="form-label" for="vertical-last-name">{!! __('locale.Year_involvement') !!}</label>
                       <input type="text" id="uyear_involvement" name="uyear_involvement" class="form-control uyear_involvement" value="{{$Form6['year_involvement']}}" readonly />
                      </div>
                  </div>
        ...
        <form>
          <div class="row">
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="vertical-last-name" name="job_type" class="form-control job_type" value="{{$form7['job_type']}}" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Monthly_income') !!}</label>
              <input type="text" id="vertical-last-name" name="monthly_income" class="form-control monthly_income" value="{{$form7['monthly_income']}}" readonly/>
            </div>
          </div>
          <div class="row">
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Year_working') !!}</label>
              <input type="date" id="vertical-last-name" name="year_working" class="form-control year_working" value="{{ Carbon\Carbon::parse($form7['year_working'])->format('Y-m-d') }}" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Company_name') !!}</label>
              <input type="text" id="vertical-last-name" name="company_name" class="form-control company_name" value="{{$form7['company_name'] }}" readonly/>
            </div>
          </div>
          <div class="row">
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-company_address">{!! __('locale.Company_address') !!}</label>
              <textarea class="form-control company_address" id="label-textarea" name="company_address" rows="4" placeholder="" readonly>{{$form7['company_address']}}</textarea>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.No_faks') !!}</label>
              <input type="text" id="vertical-last-name" name="no_faks" class="form-control no_faks" value="{{$form7['no_faks']}}" readonly/>
            </div>
          </div>
        </form>
            ...
            <div data-repeater-item>
              <div class="row d-flex align-items-end">
                <div class="col-md-4 col-12">
                  ...
                  <input type="text" class="form-control ucourse_taken" name="ucourse_taken" id="ucourse_taken" value="{{$Form8['course_taken']}}" readonly>
                  </div>
                </div>
                <div class="col-md-2 col-12">
                      <div class="mb-1">
                      <label class="form-label" for="vertical-last-name">{!! __('locale.Course_organizer') !!}</label>
                      <input type="text" id="ucourse_organizer" name="ucourse_organizer" class="form-control ucourse_organizer" value="{{$Form8['course_organizer']}}" readonly/>
                      </div>
                  </div>
                  <div class="col-md-2 col-12">
                      <div class="mb-1">
                      <label class="form-label" for="vertical-last-name">{!! __('locale.Place_taken') !!}</label>
                       <input type="text" id="uplace_taken" name="uplace_taken" class="form-control uplace_taken" value="{{$Form8['place_taken']}}" readonly/>
                      </div>
                  </div>
                  <div class="col-md-2 col-12">
                      <div class="mb-1">
                      <label class="form-label" for="vertical-last-name">Tarikh Tempoh</label>
                       <input type="text" id="uyear_taken" name="uyear_taken" class="form-control uyear_taken" value="{{$Form8['year_taken']}}" readonly/>
                      </div>
                  </div>
        ...
        <form>
          <div class="row">
            <div class="mb-1 col-md-6">
              ...
              <input type="text" id="vertical-last-name" name="sponsorship" class="form-control sponsorship" value="{{$form9['sponsorship']}}" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-address_sponsorship">{!! __('locale.Address_sponsorship') !!}</label>
              <textarea class="form-control address_sponsorship" id="label-textarea" name="address_sponsorship" rows="4" placeholder="" readonly>{{$form9['address_sponsorship']}}</textarea>
            </div>
          </div>
          <div class="row">
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Type_sponsorship') !!}</label>
              <input type="text" id="vertical-last-name" name="type_sponsorship" class="form-control type_sponsorship" value="{{$form9['type_sponsorship']}}" readonly />
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Reference_no_spsp') !!}</label>
              <input type="text" id="vertical-last-name" name="reference_no_spsp" class="form-control reference_no_spsp" value="{{$form9['reference_no_spsp']}}" readonly/>
            </div>
          </div>
          <div class="row">
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-date_offer">{!! __('locale.Date_offer') !!}</label>
              <input type="date" id="date_offer" name="date_offer" class="form-control date_offer" value="{{ Carbon\Carbon::parse($form9['date_offer'])->format('Y-m-d') }}" readonly/>
            </div>
            <div class="mb-1 col-md-6">
              <label class="form-label" for="vertical-last-name">{!! __('locale.Monthly_amount_spsp') !!}</label>
              <input type="text" id="vertical-last-name" name="monthly_amount_spsp" class="form-control monthly_amount_spsp" value="{{$form9['monthly_amount_spsp']}}" readonly/>
            </div>
          </div>
        </form>
            ...
            <div data-repeater-item>
              <div class="row d-flex align-items-end">
                <div class="col-md-4 col-12">
                  ...
                  <input type="text" class="form-control uclub" name="uclub" id="uclub" value="{{$Form10['club']}}" readonly>
                  </div>
                </div>
                <div class="col-md-3 col-12">
                      <div class="mb-1">
                      <label class="form-label" for="vertical-last-name">{!! __('locale.Role') !!}</label>
                      <input type="text" id="urole" name="urole" class="form-control urole" value="{{$Form10['role']}}" readonly/>
                      </div>
                  </div>
                  <div class="col-md-2 col-12">
                      <div class="mb-1">
                      <label class="form-label" for="vertical-last-name">{!! __('locale.Year_taken') !!}</label>
                       <input type="text" id="uyear_takenclub" name="uyear_takenclub" class="form-control uyear_takenclub" value="{{$Form10['year_taken']}}" readonly/>
                      </div>
                  </div>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  <script>
    ...
    $("#btnspm").click(function() {   
      ...
      $("#spm").append('<input hidden type="text" name="index_spm" value='+spmm+'><div data-repeater-item><div class="row d-flex align-items-end"><div class="col-md-4 col-12"><div class="mb-1"><label class="form-label" for="itemname">Subjek</label><select class="select2 form-select" id="subject_spm" name="subject_spm"><option selected disabled>Please Choose</option><option value="Bahasa Melayu">Bahasa Melayu</option><option value="Matematik">Matematik</option></select></div></div><div class="col-md-2 col-12"><div class="mb-1"><label class="form-label" for="itemcost">Grade</label><select class="select2 form-select" id="grade_spm" name="grade_spm"><option selected disabled>Please Choose</option><option value="10">A+</option><option value="9">A</option></select></div></div><div class="col-md-2 col-12"><div class="mb-1"><button class="btn btn-outline-danger text-nowrap px-1" data-repeater-delete type="button"><i data-feather="x" class="me-25"></i><span>Delete</span></button></div></div></div><hr/></div>').fadeIn();;
      feather.replace()
