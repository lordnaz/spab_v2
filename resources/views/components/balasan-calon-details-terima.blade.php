      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="/balasan_permohonan" method="post" enctype="multipart/form-data" accept-charset='UTF-8' class="form form-horizontal">
            ...
            <input type="hidden" id="balasan_calon" class="form-control" name="balasan_calon" placeholder="" value="TERIMA TAWARAN"readonly/>
              ...
              <div class="col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="label-textarea" name="balasan_calon_description" rows="4" placeholder="">{{$displaybyNRIC['balasan_calon_description'] ?? ''}}</textarea>
                                    </div>
                                </div>
                            </div>
              ...
              <div class="col-sm-3 offset-sm-9">
                ...
                <button type="submit" class="btn btn-primary">{!! __('locale.Accept') !!}</button>
