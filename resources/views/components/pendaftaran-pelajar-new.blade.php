                    ...
                    @csrf
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-sm-10">
                                    <select class="select2 form-select" id="gender" name="gender">
                                        ...
                                        <option value="Male">{!! __('locale.Male') !!}</option>
                                        <option value="Female">{!! __('locale.Female') !!}</option>
                                    </select>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-sm-10">
                                    <select class="select2 form-select" id="race" name="race">
                                        <option selected disabled>{!! __('locale.Please Choose') !!}</option>
                                        <option value="Male">{!! __('locale.Malay') !!}</option>
                                        <option value="Female">{!! __('locale.Chinese') !!}</option>
                                        <option value="Male">{!! __('locale.Indian') !!}</option>
                                        <option value="Female">{!! __('locale.Others') !!}</option>
                                    </select>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-sm-10">
                                    <select class="select2 form-select" id="faculty" name="faculty">
                                        <option selected disabled>{!! __('locale.Please Choose') !!}</option>
                                        <option value="Muzik">Fakulti Muzik</option>
                                        <option value="Tari">Fakulti Tari</option>
                                        <option value="Teater">Fakulti Teater</option>
                                    </select>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-sm-10">
                                    <select class="select2 form-select" id="status" name="status">
                                        <option selected disabled>{!! __('locale.Please Choose') !!}</option>
                                        <option data-avatar="1-small.png" value="Program Asasi">{!! __('locale.Listed') !!}</option>
                                        <option data-avatar="1-small.png" value="Program Asasi">{!! __('locale.Not Yet') !!}</option>
                                    </select>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-sm-10">
                                    <select class="select2 form-select" id="payment_type" name="payment_type">
                                        <option selected disabled>{!! __('locale.Please Choose') !!}</option>
                                        <option value="Cash">{!! __('locale.Cash') !!}</option>
                                        <option value="Bank Transfer">{!! __('locale.Bank Transfer') !!}</option>
                                        <option value="Others">{!! __('locale.Others') !!}</option>
                                    </select>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">                              
                                <div class="mb-1 row">
                                <div class="col-sm-2">
                                    <label class="col-form-label" for="reference_no_spsp">{!! __('locale.Reference_no_spsp') !!}</label>
                                </div>
                                <div class="col-sm-10">
                                    <input type="text" id="reference_no_spsp" class="form-control" name="reference_no_spsp" placeholder=""/>
                                </div>
                                </div>
                            </div>
                            <div class="col-12">                              
