...
return [
    ...
    "High Education Sub" => "High Education Info",
    ...
    "Status_Marriage" => "Marital Status",
    "Partner_Name" => "Partner Name",
    "Partner_Address" => "Partner Address",
    "Partner_Phone_No" => "Partner Phone Number",
    "Partner_House_No" => "Partner House Number",
    "Guardian_Name" => "Guardian Name",
    "Guardian_Nric_Old" => "Guardian NRIC (Old)",
    "Guardian_Nric_New" => "Guardian NRIC (New)",
    "Guardian_Phone_No" => "Guardian Phone Number",
    "Guardian_House_No" => "Guardian House Number",
    "Guardian_Address" => "Guardian Address",
    "Guardian_Email" => "Guardian Email",
    "Guardian_Income" => "Guardian Income",
    "Guardian_Occupation" => "Guardian Occupation",
    "Number_of_Dependents" => "Number of Dependents",
    "Relationship_Guardian" => "Guardian Relationship",
    "Kin_Name" => "Heirs Name",
    "Kin_Relationship" => "Heirs Relationship",
    "Kin_Phone_No" => "Heirs Phone Number",
    "Kin_House_No" => "Heirs House Number",
    "Kin_Email" => "Heirs Email",
    "Kin_Address" => "Heirs Address",
